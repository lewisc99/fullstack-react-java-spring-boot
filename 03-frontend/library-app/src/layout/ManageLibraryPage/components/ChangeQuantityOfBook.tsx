...
export const ChangeQuantityOfBook: React.FC<{
  ...
  async function increaseQuantity() {
    ...
    const quantityUpdateResponse = await fetchWithAuth(url, requestOptions);
  ...
  async function decreasedQuantity() {
    const url = `http://localhost:8080/api/admin/secure/decreased/book/quantity/?bookId=${props.book.id}`;
  ...
  async function deleteBook() {
    ...
    const UpdateResponse = await fetchWithAuth(url, requestOptions);
    ...
    <div className="card mt-3 shadow p-3 mb-3 bg-body rounded">
      <div className="row g-0">
        ...
        <div className="col-md-6">
          ...
          <button
            className="m1 btn btn-md btn-warning text-white"
